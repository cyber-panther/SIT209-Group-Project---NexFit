...
if ($("#admin-control").length) {
  ...
  function switchchange() {
    ...
    if (select) {
      ...
      document.getElementById("icon_status").src =
        "https://cyber-panther.github.io/Digital-Twin/img/lightbulb_on.svg";
      ...
      document.getElementById("icon_status").src =
        "https://cyber-panther.github.io/Digital-Twin/img/lightbulb_off.svg";
      document.getElementById("text_status").innerHTML = "Lights OFF";
      document.getElementById("color_indicator").innerHTML = "OFF";
      document.getElementById("color_indicator").src =
        "https://cyber-panther.github.io/Digital-Twin/img/bulb_off.png";
    }
  }
  ...
  function color_indicate(color) {
    ...
    switch (color) {
      case "White":
        document.getElementById("color_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/bulb_white.png";
        break;
      case "Red":
        document.getElementById("color_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/bulb_red.png";
        break;
      case "Blue":
        document.getElementById("color_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/bulb_blue.png";
        break;
      case "Green":
        document.getElementById("color_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/bulb_green.png";
        break;
      case "Yellow":
        document.getElementById("color_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/bulb_yellow.png";
        break;
  ...
  function room_indicate(id) {
    ...
    switch (room) {
      case "0":
        document.getElementById("room_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/Bluprint_l.png";
        selected = 0;
        break;
      case "1":
        document.getElementById("room_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/Bluprint_K.png";
        selected = 1;
        break;
      case "2":
        document.getElementById("room_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/Bluprint_B1.png";
        selected = 2;
        break;
      case "3":
        document.getElementById("room_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/Bluprint_B2.png";
        selected = 3;
        break;
      case "4":
        document.getElementById("room_indicator").src =
          "https://cyber-panther.github.io/Digital-Twin/img/Bluprint_T.png";
        selected = 4;
        break;
      default:
        document.getElementById("room_indicator").src =
